...
export const uploadImagesApi = async (formData: FormData): Promise<UploadImagesResponse> => {
    try {
...
export const deleteImageApi = async (imageId: string): Promise<DeleteImageResponse> => {
    try {
